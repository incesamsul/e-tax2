                    ...
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                <button class="btn bg-main btn-tambah-syariah-giro-cash-in text-white">
                                    <i class="fas fa-plus"></i>
                                    <span>Tambah</span>
                                </button>
                                <button class="btn btn-primary btn-save-syariah-giro-cash-in ml-2">
                ...
                <div class="col-lg-5">
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                <button class="btn bg-main btn-tambah-syariah-giro-cash-out text-white">
                                    <i class="fas fa-plus"></i>
                                    <span>Tambah</span>
                                </button>
                                <button class="btn btn-primary btn-save-syariah-giro-cash-out ml-2">
                                    <i class="fas fa-save"></i>
                                    <span>save</span>
                                </button>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                <button class="btn bg-main btn-tambah-syariah-deposito-cash-in text-white">
                                    <i class="fas fa-plus"></i>
                                    <span>Tambah</span>
                                </button>
                                <button class="btn btn-primary btn-save-syariah-deposito-cash-in ml-2">
                                    <i class="fas fa-save"></i>
                                    <span>save</span>
                                </button>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                <button class="btn bg-main btn-tambah-syariah-deposito-cash-out text-white">
                                    <i class="fas fa-plus"></i>
                                    <span>Tambah</span>
                                </button>
                                <button class="btn btn-primary btn-save-syariah-deposito-cash-out ml-2">
                                    <i class="fas fa-save"></i>
                                    <span>save</span>
                                </button>
                            </div>
                    ...
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                ...
                                <button class="btn btn-primary btn-save-syariah-tabungan-cash-in ml-2">
                                    <i class="fas fa-save"></i>
                                    <span>save</span>
                                </button>
                            </div>
                    ...
                    <div class="card shadow-none">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="d-flex mt-4 justify-content-end">
                                ...
                                <button class="btn btn-primary btn-save-syariah-tabungan-cash-out ml-2">
                                    <i class="fas fa-save"></i>
                                    <span>save</span>
                                </button>
                            </div>
